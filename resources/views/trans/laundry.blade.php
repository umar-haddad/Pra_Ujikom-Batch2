...
<body>
                ...
                <form id="transactionForm">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" value="{{ $customer->phone }}" name="phone" id="customerPhone" >
                        </div>
                        <div class="form-group">
                            <label for="customerAddress">Alamat *</label>
                            <input type="text" value="{{ $customer->address  }}" name="address" id="customerAddress">
                        </div>
                    </div>
                     @endforeach
                    ...
                    <div id="serviceFormSection" style="display: none;">
                        <div class="form-row">
                            <div class="form-group">
    ...
    <script>
        ...
        let servicePrice = button.getAttribute('data-price');

        console.log("Clicked Service:", serviceId, serviceName, servicePrice);
        ...
        function addToCart() {
            ...
            const prices = {
        @foreach ($services as $service)
            "{{ $service->id }}": {{ $service->price }}@if (!$loop->last),@endif
        @endforeach
    };
